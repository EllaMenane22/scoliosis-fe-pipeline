...
The CSV files in the `data/` folder of this repository are **synthetic dummy
data**. They do not contain any real patient information.

These files were created by hand purely to demonstrate the column format that
the scripts expect and to allow the pipeline to run as a worked example. The
...
If you want to run the pipeline on your own data, replace the files in `data/`
with your own CSVs using the same column headers.
